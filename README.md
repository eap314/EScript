...
The QLang interpreter is built both branched and branchless. If you do not know the pros and cons of branchless programming, [download branched](https://craft1c.net/QLang/branched). If you do want some optimizations, at the cost of a longer time between updates, [download branchless](https://craft1c.net/QLang/branchless).
